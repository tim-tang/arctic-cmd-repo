module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        download: {
            ...
            src: {
                options: {
                    header: ['define("<%= pkg.family %>/<%= pkg.name %>/<%= pkg.version %>/datatables-debug", ["$-debug"], function(require, exports, module) {', '  var jQuery = require("$-debug"); '].join('\n'),
                    footer: '});'
                },
            ...
            min: {
                options: {
                    header: ['define("<%= pkg.family %>/<%= pkg.name %>/<%= pkg.version %>/datatables", ["$"], function(require) {', '  var jQuery = require("$"); '].join('\n'),
                    footer: '});'
                },
