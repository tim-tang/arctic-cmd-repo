define("arctic-cmd-repo/backbone-subroute/0.4.2/backbone.subroute-debug", [ "gallery/underscore/1.6.0/underscore-debug", "gallery/backbone/1.1.2/backbone-debug", "$-debug" ], function(require, exports, module) {
    ...
    (function(factory) {
        if (typeof define === "function" && define.amd) {
            ...
            factory(require("gallery/underscore/1.6.0/underscore-debug"), require("gallery/backbone/1.1.2/backbone-debug"));
        } else {
        ...
        Backbone.SubRoute = Backbone.Router.extend({
            ...
            navigate: function(route, options) {
                if (route.substr(0, 1) != "/" && route.indexOf(this.prefix.substr(0, this.prefix.length - 1)) !== 0) {
                    route = this.prefix + (route ? this.separator : "") + route;
                }
            ...
            route: function(route, name, callback) {
                ...
                if (route && route.length > 0) {
                    if (this.prefix.length > 0) _route += this.separator;
                    _route += route;
                }
